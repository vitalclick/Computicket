...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/for-organizers/sell-tickets`,   changeFrequency: 'monthly', priority: 0.5 },
    { url: `${SITE_URL}/for-organizers/promoter-hub`,   changeFrequency: 'monthly', priority: 0.5 },
    { url: `${SITE_URL}/for-organizers/api-access`,     changeFrequency: 'monthly', priority: 0.5 },
    { url: `${SITE_URL}/for-organizers/payouts`,        changeFrequency: 'monthly', priority: 0.5 },
    { url: `${SITE_URL}/for-organizers/analytics`,      changeFrequency: 'monthly', priority: 0.5 },
    { url: `${SITE_URL}/for-organizers/onboarding`,     changeFrequency: 'monthly', priority: 0.5 },
